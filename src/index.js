...
router.get('/menus', await getAll(Menu))
router.get('/menus/products', await getAll(Menu, {include: Product}))
router.get('/menus/:id', await getUnique(Menu))
router.get('/menus/:id/products', await getUnique(Menu, {include: Product}))
